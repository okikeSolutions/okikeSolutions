...
Welcome to my little corner of GitHub — I build things, break things, then build them better. 🚀
...
- 🧭 Currently: Building cross-platform products with Next.js + Expo + Convex (Plan2Meal, Fidotrail, arbeo, Subwatch).
...
- 📫 Reach me: GitHub @okikeSolutions

## 🧰 Toolbox (pulled from my active builds)
...
- 🎯 Fun fact: I’m obsessed with “one repo, many platforms.”
- 🌍 Based in: Vienna.
- ☕ Fuel: Fast feedback loops, clean UI, and a little caffeine.
...
<!--
Tips:
- Replace bracketed text with real info.
- Add or remove sections freely.
- Keep it playful and you.
-->
